const getPrefixes = (id, includeFlat = true) => {
...
const calcStatus = (keys, path, reachableSet, isComplete) => {
...
const upsertPrefixNode = (tree, prefix, status) => {
 ...
 */
export const buildStatusTree = (config, { path, reachableSet, isComplete }) => {
    const prefixPairs = [];
